...
# Plot mass estimate and ground truth
plt.subplot(2,1,1)
...
# Plot CoM position estimate and ground truth
plt.subplot(2,1,2)
plt.ylim(bottom=-0.5, top=0.5)

plt.plot(t, theta_hat[1,:], label="px")
plt.plot(t, theta_hat[2,:], label="py")
plt.plot(t, theta_hat[3,:], label="pz")
...
#plt.fill_between(t, theta_hat[3,:]-theta_std[3,:], theta_hat[3,:]+theta_std[3,:], color=colors[2], alpha=0.2)
